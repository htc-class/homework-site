...
const IndexPage = () => (
  <Layout>
    ...
    <ul className="text-xl leading-loose">
      <li>
        <Link to="./year-2/week-07">Year 2, Week 7 Homework</Link>
      </li>
      <li>
        <Link to="./year-2/week-06">Year 2, Week 6 Homework</Link>
      </li>
      <li>
        <Link to="./year-2/week-05">Year 2, Week 5 Homework</Link>
      </li>
      <li>
        <Link to="./year-2/week-04">Year 2, Week 4 Homework</Link>
      </li>
      <li>
        <Link to="./year-2/week-03">Year 2, Week 3 Homework</Link>
      </li>
      <li>
        <Link to="./year-2/week-02">Year 2, Week 2 Homework</Link>
      </li>
      <li>
        <Link to="./year-2/week-01">Year 2, Week 1 Homework</Link>
      </li>
      <li>
        <Link to="./summer-4">Summer 4 Homework</Link>
      </li>
      <li>
        <Link to="./summer-3">Summer 3 Homework</Link>
      </li>
      <li>
